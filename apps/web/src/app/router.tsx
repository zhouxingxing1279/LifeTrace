...
export const router=createBrowserRouter([{path:"/",element:<Navigate to="/app/today" replace/>},{path:"/login",element:<LoginPage/>},{path:"/app",element:<ProtectedShell/>,children:[{index:true,element:<Navigate to="today" replace/>},{path:"today",element:<TodayPage/>},{path:"execution",element:<ExecutionPage/>},{path:"calendar",element:<CalendarPage/>},{path:"habits",element:<HabitsPage/>},{path:"fitness",element:<FitnessPage/>},{path:"health",element:<HealthPage/>},{path:"notes",element:<NotesPage/>},{path:"english/*",element:<EnglishPage/>},{path:"review",element:<ReviewPage/>},{path:"finance/*",element:<FinanceWorkspace/>},{path:"assistant",element:<AssistantPage/>},{path:"search",element:<SearchPage/>},{path:"settings/*",element:<SettingsPage/>},{path:"*",element:<Navigate to="today" replace/>}]},{path:"*",element:<Navigate to="/app/today" replace/>}]);
