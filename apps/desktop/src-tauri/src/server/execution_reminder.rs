...
pub async fn list_subject(
    ...
    let items = with_db!(state, |db| execution_reminder::list_subject_reminders(
        db, query
    ));
...
pub async fn list_due(
    ...
    let items = with_db!(state, |db| execution_reminder::list_due_reminders(
        db, query
    ));
    Json(items).into_response()
}
...
pub async fn update(
    ...
    let item = with_db!(state, |db| execution_reminder::update_reminder(
        db, &id, input
    ));
    Json(item).into_response()
}
...
pub async fn snooze(
    ...
    let item = with_db!(state, |db| execution_reminder::snooze_reminder(
        db, &id, input
    ));
    Json(item).into_response()
}
